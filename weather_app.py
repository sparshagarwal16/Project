...
frame = Frame(m, bg='skyblue')
frame.pack()
#w = Canvas(frame, width=200, height=100, bg='lavender')
#w.pack(side=TOP)
#T = Text(frame, height=20, width=30, bg='skyblue')
#T.pack()
# T.insert(END, fetch_data())
city_label = Label(frame,text="Enter city: ", bg='skyblue')
city_label.grid(row=0,column=0)
city_entry = Entry(frame)
city_entry.grid(row=0,column=1)
show = Button(frame,text="Show Weather", bg='skyblue',fg='black',activeforeground='grey', command=fetch_data)
